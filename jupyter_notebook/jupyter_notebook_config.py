...
# ************
# NOTE the below with '*' should normally work except in the latest version. I'm using a work around.
# This may require an update at a later stagge.
# c.NotebookApp.ip = '*'
